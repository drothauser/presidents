...
/**
 * Checks whether the state being validated is associated with one or more
 * presidents.
 *
 * @author drothauser
 */
...
public @interface HasPresidentsCheck {
	 ...
	 */
	String message() default "{state.has.presidents}";
	...
	/**
	 * Validates whether a state id is associated with one or more presidents.
	 * 
	 * @author drothauser
	 *
	 */
